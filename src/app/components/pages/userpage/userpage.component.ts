...
export class UserpageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.currentUser.profilePic === '') {
      ...
      this.userImg = `https://pear-confused-colt.cyclic.app/${this._auth.selectedUser.profilePic}`;
    }
    ...
    if (this._auth.userData.profilePic === '') {
      ...
      this.userImage = `https://pear-confused-colt.cyclic.app/${this._auth.userData.profilePic}`;
    }
  }
  ...
  addFriend() {
    this.friendsBtnStatus = true;
    this._auth
      .addFriend(this._auth.selectedUser._id, this._auth.userData._id)
      .subscribe(
  ...
  removeFriend() {
    ...
    this._auth
      .deleteFriend(this._auth.selectedUser._id, this._auth.userData._id)
      .subscribe(
        (res) => console.log(res.message),
        (err) => console.log(err)
      );
